...
namespace Jellyfin.Plugin.TagTurbo.Tasks;

/// <summary>
/// Scheduled task that removes expired TagTurbo image cache files.
/// </summary>
public class CacheCleanupTask : IScheduledTask
{
    ...
    /// <inheritdoc />
    public string Name => "TagTurbo Cache Cleanup";

    /// <inheritdoc />
    public string Key => "TagTurboCacheCleanup";

    /// <inheritdoc />
    public string Description => "Removes expired TagTurbo image cache files";

    /// <inheritdoc />
    public string Category => "TagTurbo";
    ...
    public Task ExecuteAsync(IProgress<double> progress, CancellationToken cancellationToken)
    {
        ...
        _logger.LogInformation("TagTurbo cache cleanup complete. Deleted {Count} expired files", deletedCount);
        return Task.CompletedTask;
    }
}
