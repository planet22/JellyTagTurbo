...
namespace Jellyfin.Plugin.TagTurbo;

/// <summary>
/// TagTurbo plugin - Adds quality badges to media posters.
/// </summary>
public class Plugin : BasePlugin<PluginConfiguration>, IHasWebPages
{
    ...
    /// <inheritdoc />
    public override string Name => "TagTurbo";

    /// <inheritdoc />
    public override Guid Id => Guid.Parse("f4a2e8c1-9b3d-4f7a-b6c5-2d8e1a3f9b04");

    /// <inheritdoc />
    public override string Description => "Adds quality/source badges (4K, 1080p, etc.) to media posters and thumbnails.";
