...
namespace Jellyfin.Plugin.TagTurbo.Configuration;
...
public class ImageTypeConfig
{
    ...
    public BadgePanelSettings SourcePanel { get; set; } = new();
    public BadgePanelSettings FileTypePanel { get; set; } = new();
...
public class PluginConfiguration : BasePluginConfiguration
{
    ...
    public void MigrateFromLegacy()
    {
        ...
        void MigrateImageType(ImageTypeSettings? old, ImageTypeConfig target)
        {
            ...
            // Source panel (new) – sensible defaults
            target.SourcePanel.Enabled = true;
            target.SourcePanel.Order = 5;
            target.SourcePanel.Position = BadgePosition.TopRight;
            target.SourcePanel.Layout = BadgeLayout.Vertical;
            target.SourcePanel.SizePercent = old.BadgeSizePercent > 0 ? old.BadgeSizePercent : 15;
            target.SourcePanel.MarginPercent = old.BadgeMarginPercent;
            target.SourcePanel.GapPercent = old.BadgeGapPercent;
            target.SourcePanel.Style = old.BadgeStyle;
            target.SourcePanel.EnabledBadges = new List<string> { "dvd", "bluray" };

            // File type panel (new) – sensible defaults
            target.FileTypePanel.Enabled = true;
            target.FileTypePanel.Order = 6;
            target.FileTypePanel.Position = BadgePosition.BottomRight;
            target.FileTypePanel.Layout = BadgeLayout.Vertical;
            target.FileTypePanel.SizePercent = old.BadgeSizePercent > 0 ? old.BadgeSizePercent : 15;
            target.FileTypePanel.MarginPercent = old.BadgeMarginPercent;
            target.FileTypePanel.GapPercent = old.BadgeGapPercent;
            target.FileTypePanel.Style = old.BadgeStyle;
            target.FileTypePanel.EnabledBadges = new List<string> { "strm" };
        }
    ...
    private static ImageTypeConfig CreateDefaultPosterConfig()
    {
        ...
        config.SourcePanel = new BadgePanelSettings
        {
            Enabled = true, Order = 5, Position = BadgePosition.TopRight,
            Layout = BadgeLayout.Vertical, SizePercent = 15, MarginPercent = 2f, GapPercent = 10f,
            EnabledBadges = new List<string> { "dvd", "bluray" }
        };
        config.FileTypePanel = new BadgePanelSettings
        {
            Enabled = true, Order = 6, Position = BadgePosition.BottomRight,
            Layout = BadgeLayout.Vertical, SizePercent = 15, MarginPercent = 2f, GapPercent = 10f,
            EnabledBadges = new List<string> { "strm" }
        };
