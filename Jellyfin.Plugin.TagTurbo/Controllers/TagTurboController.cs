...
namespace Jellyfin.Plugin.TagTurbo.Controllers;

/// <summary>
/// Controller for TagTurbo plugin admin and debug endpoints.
/// </summary>
[ApiController]
[Route("TagTurbo")]
public partial class TagTurboController : ControllerBase
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TagTurboController"/> class.
    /// </summary>
    public TagTurboController(IImageCacheService cacheService, IImageOverlayService overlayService, IQualityDetectionService qualityService)
    {
    ...
    public IActionResult ExportConfig()
    {
        ...
        return File(json, "application/json", "tagturbo-config.json");
    }
